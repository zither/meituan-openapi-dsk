...
class ProductService extends RpcService
{
    ...
    {
        return $this->client->call('waimai/dish/queryCatList');
    }
    ...
    {
        return $this->client->call('waimai/dish/updateCat', ['oldCatName' => $oldCatName, 'catName' => $catName, 'sequence' => $sequence]);
    }
    ...
    {
        return $this->client->call('waimai/dish/deleteCat', ['catName' => $catName]);
    }
    ...
    {
        return $this->client->call('waimai/dish/queryBaseListByEPoiId', ['ePoiId' => $ePoiId]);
    }
    ...
    {
        return $this->client->call('waimai/dish/queryListByEPoiId', ['ePoiId' => $ePoiId, 'offset' => $offset, 'limit' => $limit]);
    }
    ...
    {
        return $this->client->call('waimai/dish/mapping', ['ePoiId' => $ePoiId, 'dishMappings' => $dishMappings]);
    }
    ...
    {
        return $this->client->call('waimai/dish/queryListByEPoiId', ['ePoiId' => $ePoiId, 'dishes' => $dishes]);
    }
